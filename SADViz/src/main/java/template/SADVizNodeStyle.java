...
public class SADVizNodeStyle implements GraphNodeStyle {
	
	protected static final Color BG = new Color(18, 186, 213);
	protected static final int SHAPE_ARC = 8;
	...
	public SADVizNodeStyle() {
		loadDefaultColors();
		this.nextColorIndex = 0;
		this.nodeTypeToPaint = new HashMap<Object, Paint>();
		this.defaultNodeColor = BG;
		this.bgPaint = new GradientPaint(0, 0, defaultNodeColor, 0, 20, new Color(85, 19, 195), true);

		borderPaint = Color.black;
		borderHighlightPaint = Color.blue;
		borderSelectionPaint = Color.green;
