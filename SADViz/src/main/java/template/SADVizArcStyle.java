...
public class SADVizArcStyle implements GraphArcStyle {

	private static final float THICK_STROKE_WIDTH = 10f;
	private static final float MEDIUM_STROKE_WIDTH = 6f;
	private static final float THIN_STROKE_WIDTH = 2f;
	...
	protected void loadDefaultColors() {
		...
		defaultColors[0] =  new Color(19,  222,  41); //indianred
		defaultColors[1] =  new Color( 58, 234, 184); //steelblue
		defaultColors[2] =  new Color(37,  162, 238); //mediumorchid
		defaultColors[3] =  new Color(52, 119,  235); //chocolate
		defaultColors[4] =  new Color(33, 21,   219); //gold
		defaultColors[5] =  new Color(137, 29,  234); //peru
		defaultColors[6] =  new Color(196, 39, 234); //grey
		defaultColors[7] =  new Color(234, 39, 228); //limegreen
		defaultColors[8] =  new Color(234, 39, 137); //darkviolet
		defaultColors[9] =  new Color(234, 39, 95); //olive
		defaultColors[10] = new Color(13, 144, 27); //darkkahki
		defaultColors[11] = new Color(77, 161, 59); //darkorange
		defaultColors[12] = new Color( 158, 225, 54 ); //darkgreen
		defaultColors[13] = new Color(239, 236, 26); //blue-purple
